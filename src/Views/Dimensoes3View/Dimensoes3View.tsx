...
export default function dimensoes3() {
        ...
        <Box sx={{ flexGrow: 1 }}>
            ...
            <Paginacao/>
             <Typography variant="h5" sx={{ mb: 3, color: '#172E4D' }}>  Formulário</Typography>
                    <FormLabel component="legend" sx={{ mb: 2, color: '#172E4D' }}>1. Integração Vertical</FormLabel>
                    <RadioGroup
                    ...
                    <FormLabel component="legend" sx={{ mb: 2, color: '#172E4D' }}>2. Integração Horizontal</FormLabel>
                    <RadioGroup
